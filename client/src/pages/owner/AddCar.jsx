...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <Title title="Add a Car" subTitle="Ready to share your car? Add the pricing, availability, and a few details to get started!"/>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center gap-2 w-full'>
          ...
          <p className='text-sm text-gray-500'>Snap and upload a picture of your car to complete the listing.</p>
        </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            <label>Daily Rental Price ({currency})</label>
